    ...
    <HeroSection>
      <HeroContainer>
        ...
        <HeroContent>
          ...
          <HeroSubtitle>
            Streamline your campus events with our comprehensive platform for event creation,
            attendance tracking, and real-time analytics.
          </HeroSubtitle>
          <HeroButtons>
            <ButtonContainer>
              ...
              {}
              <Button as="a" href="#learn-more" variant="secondary">
                Learn More
              </Button>
            </ButtonContainer>
          </HeroButtons>
